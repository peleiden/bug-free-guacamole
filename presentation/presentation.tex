...
\begin{frame}
    ...
    \begin{itemize}
        \item Mål: Finde fastdefinerede, verdslige objekter i et dokument
...
\begin{frame}
    \frametitle{Sprogmodellers todeling}
    Sprogmodeller som BERT og LUKE er opdelt i to:
    \begin{itemize}
        \item En prætrænet model, encoderen, der har lært generel sprogforståelse, men i sig selv ikke har nogen praktisk anvendelse
        \item Viden er en stor fordel i NER
        \item En fine-tuningsudvidelse, der målrettes en specifik opgave, fx NER. Typisk ét lineært lag
    \end{itemize}
...
\begin{frame}
    \frametitle{NER på dansk}
    DaLUKE er den næstbedste danske NER-model på DaNE -- dog med betydelig usikkerhed
    \begin{table}[H]
...
\begin{frame}
    ...
    \begin{figure}[H]
        \centering
        \only<1>{\includegraphics[width=.6\linewidth]{pos-geo/pca_matrix}}
        \only<2->{
            \begin{tikzpicture}
                \node[above right, inner sep=0] (image) at (0,0) {
                    \includegraphics[width=.9\linewidth]{pos-geo/umap}
                };
            % Create scope with normalized axes
                ...
                \draw<3->[stealth-, thick, black] (2.5,8.5) -- ++(0.5,0.25)
                    node[right,black,fill=white]{\small Danmark};
                \draw<4->[stealth-, thick, black] (4.7, 8.2) -- ++(0.5,0)
                    node[right,black,fill=white]{\small København};
                \draw<5->[stealth-, thick, black] (6.3, 7) -- ++(0.5,0)
                    node[right,black,fill=white]{\small EF};
                \draw<6->[stealth-, thick, black] (6.8, 3) -- ++(0.5,0)
                    node[right,black,fill=white]{\small Hafnia};
                \draw<7>[stealth-, thick, black] (5.8, 1.8) -- ++(0.5,0)
                    node[right,black,fill=white]{\small Baltisk};
                \end{scope}
            \end{tikzpicture}
        }
    \end{figure}\noindent
