...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \uncover<2->{\item Entitetsannoteringer gør det lettere at gætte skjulte ord}
        \uncover<3->{\item Entitetstype afhænger af kontekst}
    \end{itemize}
        \column{0.5\textwidth}
    \begin{example}
        \footnotesize
        ...
        \begin{itemize}
            \item Han: Bo Møller
            \item Hun: Bente Møller
            \item Harvard University: Peteran %Michael, John Brown var også på listen
        \end{itemize}
        }
        \only<3>{
