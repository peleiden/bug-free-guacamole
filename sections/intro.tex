...
In NLP, enhancing deep neural networks with using knowledge is not just an idea for the future; several approaches have been presented in recent years, a subset of which will be summarized here.

% Tag udgangspunkt i nedenstående liste af metoder og skriv en temaopdelt gennemgang
%% ERNIE
%% Know-BERT
%% WKLM
%% KEPLER
