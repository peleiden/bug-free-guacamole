...
\begin{figure}[H]
    ...
    \caption{
        ...
        To the right, the number of predictions of each class on the dev. set is shown along with the actual number of each class.
    }
...
One possible explanation for this could be that the pretraining dataset is biased towards locations and people, but this is not investigated further.
