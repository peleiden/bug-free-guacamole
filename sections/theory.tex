...
Natural language processing has the broad goal of algorithmically understanding languages such as English and Danish.
To quantify this abstract ideal, understanding is often measured in performance on a set of well-defined language challenges that are expected to require general language knowledge.
One such challenge is the task of recognizing \emph{named entities} (NEs), real-world objects with rigid definitions such as specific persons, locations, organizations, events, products, etc.
