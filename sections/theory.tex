...
When using the term \emph{embeddings}, we refer to the static, decontextualized representations such as the \emph{fasttext}-based, 300-dimensional, Danish embeddings released by Edouard Grave et al. \cite{grave2018learning}.
...
Each of the attention blocks are each made up of three, learnable components: the query, key, and value matrices.
...
\begin{figure}[H]
    \centering
        \includegraphics[width=0.49\linewidth]{encoder}
    ...
    \caption{
        ...
        The right image exemplifies attention between all words in as the BERT encoder computes it.
...
The combination of statistical methods and explicit human crafted domain knowledge was the SOTA in many NLP tasks in the 1990's and up into the 2000's \cite[Sec. 22.5]{russell2016ai}.
