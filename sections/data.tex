...
Thus, an entry in the dataset consists of the following four parts:
\begin{itemize}
%TODO Spacing
...
\end{itemize}
The dataset is the set of all such entries from all articles.
...
These steps increase the number of entity annotations from 4,693,505 to 6,956,690.
