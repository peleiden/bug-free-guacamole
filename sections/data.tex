...
\begin{figure}[H]
    ...
    \caption{
        ...
        Notably, DaNE and Plank do not have the same distributions the three datasubsets, with e.g. LOC being under-represented in the DaNE test set and MISC being under-represented in the Plank training set.
