...
\begin{figure}[H]
    ...
    \caption{The parameter distribution before and after pretraining.}
\end{figure}\noindent
...
Even with this limit and with hyperparameters chosen to favour global structure, $t$-SNE and UMAP results were difficult to intepret, see Appendix~\ref{sec:dimeru}, motivating visualizing the data set where only the 4003 entity spans that corresponded to true entity annotations were included.
