...
Even with this limit and with hyperparameters chosen to favour global structure, only messy, hairy ball plots were achieved from $t$-SNE and UMAP, motivating an extra visualization where only the 4003 entity spans that corresponded to true entity annotations were included.
