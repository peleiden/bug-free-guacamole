...
\begin{enumerate}
    \item Skal der være tekst-opsamling på vores tanker om finetuningen og bekymringen for overfit her?
\end{enumerate}
...
\begin{enumerate}
    \item Fjern precision og recall for ikke-MISC modeller/datasæt.
    \item Mangler diskussion: Vi skal problematisere NER-opgavens generaliserbarhed; bl.a. de forskellige forståelse af begreberne of entititer.
    \item Inkluder evt. ref fig:dadatadist og tab:danedist
\end{enumerate}
...
\begin{enumerate}
    \item Diskussion, hvor vi glæder os over, at det samlede er bedst, men spekulerer i, at NER kunne køres helt uden ord-repræsentationer.
\end{enumerate}
