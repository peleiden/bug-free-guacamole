...
\begin{table}[H]
    ...
    Baseline                & 82.4&89.5&92.9&74.4&68.8      & 86.7                          & 78.4
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{l|ccccc|c|c}
        \multirow{2}{*}{Model}  & \multicolumn{5}{c|}{F1 [\pro]} & Precision [\pro]               & Recall [\pro]               \\
                            & Avg. & LOC & PER & ORG & MISC      & Avg.                           & Avg.                         \\ \hline
    BERT attention          & 79.6 & 85.8 & 92.8 & 70.9 &   64.8      & 84.5                          & 75.2
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{l|ccccc|c|c}
        \multirow{2}{*}{Model}  & \multicolumn{5}{c|}{F1 [\pro]} & Precision [\pro]               & Recall [\pro]               \\
                            & Avg. & LOC & PER & ORG & MISC      & Avg.                           & Avg.                         \\ \hline
    No data aug.            & 83.0&84.4&95.1&76.4&72.1      & 85.4                          & 80.8
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{l|ccccc|c|c}
        \multirow{2}{*}{Model}  & \multicolumn{5}{c|}{F1 [\pro]} & Precision [\pro]               & Recall [\pro]               \\
                            & Avg. & LOC & PER & ORG & MISC      & Avg.                           & Avg.                         \\ \hline
    No transfer learning    & 71.0&79.0&83.5&55.4&61.7      & 76.9                          & 65.9
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{l|ccccc|c|c}
        \multirow{2}{*}{Model}  & \multicolumn{5}{c|}{F1 [\pro]} & Precision [\pro]               & Recall [\pro]               \\
                            & Avg. & LOC & PER & ORG & MISC      & Avg.                           & Avg.                         \\ \hline
    Limited entity vocab.   & 82.2&89.6&93.5&74.0&68.7      & 85.0                          & 79.5
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{l|ccccc|c|c}
        \multirow{2}{*}{Model}  & \multicolumn{5}{c|}{F1 [\pro]} & Precision [\pro]               & Recall [\pro]               \\
                            & Avg. & LOC & PER & ORG & MISC      & Avg.                           & Avg.                        \\ \hline
    Baseline                & 82.4&89.5&92.9&74.4&68.8      & \textbf{86.7}                          & 78.4                       \\
    BERT attention          & 79.6 & 85.8 & 92.8 & 70.9 &   64.8      & 84.5                          & 75.2 \\
    No data augmentation    & \textbf{83.0}&84.4&\textbf{95.1}&\textbf{76.4}&\textbf{72.1}      & 85.4                          & \textbf{80.8}                       \\
    No transfer learning    & 71.0&79.5&83.5&55.4&61.7      & 76.9                          & 65.9                       \\
    Limited entity vocab.   & 82.2&\textbf{89.6}&93.5&74.00&68.7      & 85.0                          & 79.5
    \end{tabular}
...
\begin{table}[H]
    ...
    \begin{tabular}{l|ccccc|c|c}
        \multirow{2}{*}{Model}  & \multicolumn{5}{c|}{F1 [\pro]} & Precision [\pro]               & Recall [\pro]               \\
                       & Avg.           & LOC            & PER            & ORG            & MISC           & Avg.           & Avg.  \\ \hline
        Subword tokens & 81.2          & \textbf{87.6} & 92.4          & 70.9          & 71.6          & 84.6          & 78.1 \\
        Entity tokens  & 81.7          & 85.1          & 93.2          & 71.4          & 74.0          & \textbf{85.0} & 78.6 \\
        Both (default) & \textbf{82.8} & 87.0          & \textbf{94.1} & \textbf{73.1} & \textbf{74.5} & 84.6          & \textbf{81.1}
    \end{tabular}
    \caption{
