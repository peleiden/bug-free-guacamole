...
The contextualized word representation model LUKE (Language Understanding using Knowledge Embeddings) combines explicit knowledge of named entities mined from Wikipedia with the Deep Learning in the form the Transformer architecture. %TODO: Citér
